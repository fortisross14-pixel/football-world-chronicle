...
function magazinePage(tabRaw = 'results') {
  const tab = ['preseason','transfers','results','players','rankings','fhof'].includes(tabRaw) ? tabRaw : 'results';
